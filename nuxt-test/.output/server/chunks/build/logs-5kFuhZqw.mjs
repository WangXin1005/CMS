...
import { w as withInstall, f as withNoopInstall, c as buildProps, u as useSizeProp, e as request, d as definePropType, b as addUnit } from './request-CPAxCwDy.mjs';
    ...
    function getUpdateDiff(row) {
      ...
      if (!oldObj) {
        ...
        for (const key of Object.keys(newObj)) {
          ...
          changes2.push({ key: displayKey2, oldVal: null, newVal: newObj[key] });
        }
                            ...
                            if (updateDiff.value) {
                              ...
                              ssrRenderList(updateDiff.value, (c) => {
                                ...
                                if (c.oldVal != null && c.newVal != null && (isDiffable(c.oldVal) || isDiffable(c.newVal)) && !unref(selectFields).has(c.key) && c.key !== "Logo URL") {
                                  ...
                                  _push4(`<!--[--><span style="${ssrRenderStyle({ "color": "#f56c6c", "text-decoration": "line-through" })}"${_scopeId3}>${ssrInterpolate(formatDiffVal(c.oldVal))}</span><span style="${ssrRenderStyle({ "margin": "0 6px", "color": "#909399" })}"${_scopeId3}>→</span><span style="${ssrRenderStyle({ "color": "#67c23a", "font-weight": "bold" })}"${_scopeId3}>${ssrInterpolate(formatDiffVal(c.newVal))}</span><!--]-->`);
                                }
                                _push4(`</div>`);
                              });
                              _push4(`<!--]--></div>`);
                                ...
                                (openBlock(true), createBlock(Fragment, null, renderList(updateDiff.value, (c) => {
                                  return openBlock(), createBlock("div", {
                                    ...
                                    c.oldVal != null && c.newVal != null && (isDiffable(c.oldVal) || isDiffable(c.newVal)) && !unref(selectFields).has(c.key) && c.key !== "Logo URL" ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList(computeCharDiff(String(c.oldVal ?? ""), String(c.newVal ?? "")), (seg) => {
                                      ...
                                      createVNode("span", { style: { "color": "#f56c6c", "text-decoration": "line-through" } }, toDisplayString(formatDiffVal(c.oldVal)), 1),
                                      createVNode("span", { style: { "margin": "0 6px", "color": "#909399" } }, "→"),
                                      createVNode("span", { style: { "color": "#67c23a", "font-weight": "bold" } }, toDisplayString(formatDiffVal(c.newVal)), 1)
                                    ], 64))
                                  ]);
                                }), 128))
...
//# sourceMappingURL=logs-5kFuhZqw.mjs.map
