import { E as ElButton, a as ElMessage } from './request-CHJHyar9.mjs';
...
import { _ as __nuxt_component_8 } from './RichTextEditor-CbI6iXw0.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "overflow-y": "auto", "height": "100%" } }, _attrs, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-3371493f><div class="page-header" data-v-3371493f><h2 data-v-3371493f>编辑文章</h2><div data-v-3371493f>`);
      ...
      _push(`</div></div>`);
      if (!loading.value) {
        _push(`<div class="page-card" data-v-3371493f>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3371493f"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-WlBKzrOv.mjs.map
