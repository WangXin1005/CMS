import { f as ElIcon, P as arrow_left_default, a9 as arrow_down_default, E as ElButton, an as ElMenu, ao as ElMenuItem, ap as home_filled_default, F as document_default, aq as folder_default, ar as price_tag_default, as as picture_default, v as user_default, at as setting_default, au as list_default, z as withNoopInstall, w as withInstall, a as ElMessage, k as buildProps, m as iconPropType, Y as componentSizes, o as definePropType, a7 as useTooltipContentProps, av as roleTypes, aw as useTooltipTriggerProps, a3 as EVENT_CODE, ax as composeEventHandlers, a2 as getEventCode, ay as OnlyChild, b as ElTooltip, D as useLocale, j as addUnit, g as useFormSize, az as whenMouse, B as flattedChildren, _ as _plugin_vue_export_helper_default } from './request-BRr5oPTU.mjs';
import { _ as _export_sfc, d as useRoute, i as isNumber, q as useId, h as useNamespace } from './server.mjs';
...
import { E as ElScrollbar } from './el-scrollbar-4HhrLvPo.mjs';
import { useEventListener } from '@vueuse/core';
import { E as ElDialog, c as composeRefs } from './el-dialog-CG1pGxRa.mjs';
import { isString } from '@vue/shared';
import { placements } from '@popperjs/core';
import { E as ElForm, a as ElFormItem } from './el-form-item-DAPAhOf6.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_header, { class: "admin-header" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header-left" data-v-21ff06b8${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-21ff06b8${_scopeId2}>返 回 博 客</span>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="header-right" data-v-21ff06b8${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_dropdown, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="user-info" data-v-21ff06b8${_scopeId2}>`);
                  ...
                  _push3(`<span class="username" data-v-21ff06b8${_scopeId2}>${ssrInterpolate(unref(username))}</span>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-21ff06b8"]]), { __name: "Header" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_el_icon = ElIcon;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "menu-container" }, _attrs))} data-v-ebe3c03c><div class="menu-logo" data-v-ebe3c03c><span class="logo-icon" data-v-ebe3c03c>`);
      if (siteLogo.value) {
        _push(`<img${ssrRenderAttr("src", siteLogo.value)} class="logo-img" alt="logo" data-v-ebe3c03c>`);
      } else {
        _push(`<span class="logo-emoji" data-v-ebe3c03c>📝</span>`);
      }
      _push(`</span><span class="logo-text" data-v-ebe3c03c>${ssrInterpolate(siteName.value)}</span></div>`);
            ...
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/home" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-ebe3c03c${_scopeId2}>仪表盘</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
            ...
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/articles" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-ebe3c03c${_scopeId2}>文章管理</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
            ...
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/categories" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-ebe3c03c${_scopeId2}>分类管理</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
            ...
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/tags" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-ebe3c03c${_scopeId2}>标签管理</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/media" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-ebe3c03c${_scopeId2}>媒体管理</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/user" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-ebe3c03c${_scopeId2}>用户管理</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/setting" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-ebe3c03c${_scopeId2}>站点设置</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/logs" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-ebe3c03c${_scopeId2}>操作日志</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-ebe3c03c"]]), { __name: "Menu" });
const _sfc_main = {};
...
//# sourceMappingURL=default-qVTsScEX.mjs.map
