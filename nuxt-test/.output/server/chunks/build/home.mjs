import { E as ElTooltip } from './el-popper.mjs';
import { w as withInstall, g as useGlobalConfig, c as buildProps, d as definePropType } from './request.mjs';
...
import { E as ElRow, a as ElCol } from './el-col.mjs';
import { E as ElEmpty } from './el-empty.mjs';
import { E as ElTag } from './index4.mjs';
import { E as ElDialog } from './el-dialog.mjs';
import { E as ElDivider } from './el-divider.mjs';
import { E as ElButton } from './el-button.mjs';
...
import { s as sanitizeHtml } from './sanitize.mjs';
import { u as useArticle } from './useArticle.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page-wrapper" }, _attrs))} data-v-32a84578><div data-v-32a84578><div class="page-header" data-v-32a84578><h2 data-v-32a84578>仪表盘</h2></div><div${ssrRenderAttrs(mergeProps({ class: "stats-grid" }, ssrGetDirectiveProps(_ctx, _directive_loading, statsLoading.value)))} data-v-32a84578>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_card, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="stat-value" style="${ssrRenderStyle({ "color": "#409eff" })}" data-v-32a84578${_scopeId2}>${ssrInterpolate(stats.value.totalArticles)}</div><div class="stat-label" data-v-32a84578${_scopeId2}>文章总数</div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "stat-value",
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="stat-value" style="${ssrRenderStyle({ "color": "#67c23a" })}" data-v-32a84578${_scopeId}>${ssrInterpolate(stats.value.totalCategories)}</div><div class="stat-label" data-v-32a84578${_scopeId}>分类总数</div>`);
          } else {
            return [
              createVNode("div", {
                class: "stat-value",
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="stat-value" style="${ssrRenderStyle({ "color": "#e6a23c" })}" data-v-32a84578${_scopeId}>${ssrInterpolate(stats.value.totalTags)}</div><div class="stat-label" data-v-32a84578${_scopeId}>标签总数</div>`);
          } else {
            return [
              createVNode("div", {
                class: "stat-value",
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="stat-value" style="${ssrRenderStyle({ "color": "#f56c6c" })}" data-v-32a84578${_scopeId}>${ssrInterpolate(stats.value.totalComments)}</div><div class="stat-label" data-v-32a84578${_scopeId}>评论总数</div>`);
          } else {
            return [
              createVNode("div", {
                class: "stat-value",
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_card, { shadow: "never" }, {
                    header: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span data-v-32a84578${_scopeId3}>近期文章</span>`);
                      } else {
                        return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_loading, articlesLoading.value))} data-v-32a84578${_scopeId3}>`);
                        ...
                        ssrRenderList(recentArticles.value, (item, i) => {
                          _push4(`<div class="${ssrRenderClass([{ clickable: canClick.value }, "recent-item"])}" data-v-32a84578${_scopeId3}><span class="recent-index" data-v-32a84578${_scopeId3}>${ssrInterpolate(i + 1)}</span><span class="${ssrRenderClass([{ clickable: canClick.value }, "recent-title"])}" data-v-32a84578${_scopeId3}>${ssrInterpolate(item.title)}</span><span class="recent-status" data-v-32a84578${_scopeId3}>`);
                          ...
                          _push4(`</span><span class="recent-date" data-v-32a84578${_scopeId3}>${ssrInterpolate((item.createdAt || "").replace("T", " ").slice(0, 16))}</span></div>`);
                        });
                        _push4(`<!--]--></div>`);
                      } else {
                        return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_card, { shadow: "never" }, {
                      header: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span data-v-32a84578${_scopeId3}>快捷操作</span>`);
                        } else {
                          return [
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="quick-actions" data-v-32a84578${_scopeId3}><div class="quick-action-item" data-v-32a84578${_scopeId3}><div class="qa-icon" data-v-32a84578${_scopeId3}>✍️</div><div class="qa-label" data-v-32a84578${_scopeId3}>写文章</div></div><div class="quick-action-item" data-v-32a84578${_scopeId3}><div class="qa-icon" data-v-32a84578${_scopeId3}>📋</div><div class="qa-label" data-v-32a84578${_scopeId3}>文章管理</div></div><div class="quick-action-item" data-v-32a84578${_scopeId3}><div class="qa-icon" data-v-32a84578${_scopeId3}>💬</div><div class="qa-label" data-v-32a84578${_scopeId3}>评论管理</div></div></div>`);
                        } else {
                          return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (dialogArticle.value) {
              _push2(`<!--[--><h2 style="${ssrRenderStyle({ "font-size": "20px", "margin": "0 0 12px", "color": "#1a1a1a" })}" data-v-32a84578${_scopeId}>${ssrInterpolate(dialogArticle.value.title)}</h2><div style="${ssrRenderStyle({ "font-size": "13px", "color": "#999", "margin-bottom": "16px" })}" data-v-32a84578${_scopeId}><span data-v-32a84578${_scopeId}>✍ ${ssrInterpolate(dialogArticle.value.author?.username)}</span><span style="${ssrRenderStyle({ "margin-left": "16px" })}" data-v-32a84578${_scopeId}>${ssrInterpolate((dialogArticle.value.createdAt || "").replace("T", " ").slice(0, 16))}</span>`);
              ...
              if (dialogArticle.value.tags?.length) {
                _push2(`<div style="${ssrRenderStyle({ "margin-bottom": "12px" })}" data-v-32a84578${_scopeId}><!--[-->`);
              ...
              _push2(`<div class="article-content-render" style="${ssrRenderStyle({ "max-height": "400px", "overflow-y": "auto" })}" data-v-32a84578${_scopeId}>${unref(sanitizeHtml)(dialogArticle.value.content) ?? ""}</div><!--]-->`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-32a84578"]]);
