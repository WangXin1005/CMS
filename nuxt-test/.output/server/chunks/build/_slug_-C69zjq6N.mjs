...
import { E as ElMessage } from './request-D_zzMMA3.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "comment-section" }, _attrs))} data-v-60ffe74c><h3 class="comment-title" data-v-60ffe74c>💬 评论 (${ssrInterpolate(comments.value.length)})</h3>`);
      if (unref(isLoggedIn)) {
        _push(`<div class="comment-form" data-v-60ffe74c><div class="${ssrRenderClass({ atLimit: newComment.value.length >= 1e3 })}" data-v-60ffe74c>`);
        ...
        _push(`</div><div class="form-actions" data-v-60ffe74c>`);
        ...
        _push(`<div class="login-hint" data-v-60ffe74c><p data-v-60ffe74c>请 `);
      ...
      if (loading.value) {
        _push(`<div class="comments-loading" data-v-60ffe74c>`);
        ...
        _push(`<div class="comments-empty" data-v-60ffe74c>暂无评论</div>`);
      } else {
        _push(`<div class="comments-list" data-v-60ffe74c><!--[-->`);
        ssrRenderList(comments.value, (comment) => {
          _push(`<div class="comment-item" data-v-60ffe74c><div class="comment-header" data-v-60ffe74c><strong data-v-60ffe74c>${ssrInterpolate(comment.author?.username || "匿名")}</strong><span class="comment-date" data-v-60ffe74c>${ssrInterpolate((comment.createdAt || "").replace("T", " ").slice(0, 16))}</span></div><p class="comment-content" data-v-60ffe74c>${ssrInterpolate(comment.content)}</p></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div>`);
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-60ffe74c"]]), { __name: "CommentSection" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!loading.value && article.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "article-detail-layout" }, _attrs))} data-v-c1d6307b><div class="detail-main" data-v-c1d6307b><div class="sticky-header" data-v-c1d6307b><div class="back-bar" data-v-c1d6307b>`);
        _push(ssrRenderComponent(_component_el_button, {
          size: "small",
          class: "back-btn",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg viewBox="0 0 24 24" width="14" height="14" style="${ssrRenderStyle({ "margin-right": "2px" })}" data-v-c1d6307b${_scopeId}><path fill="currentColor" d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z" data-v-c1d6307b${_scopeId}></path></svg> 返回 `);
            } else {
              return [
        ...
        _push(`</div><div class="article-header" data-v-c1d6307b><h1 class="article-title" data-v-c1d6307b>${ssrInterpolate(article.value.title)}</h1><div class="article-meta" data-v-c1d6307b><span data-v-c1d6307b>👤 ${ssrInterpolate(article.value.author?.username)}</span><span data-v-c1d6307b>📅 ${ssrInterpolate(formattedDate.value)}</span><span data-v-c1d6307b>👁 ${ssrInterpolate(article.value.viewCount)} 次阅读</span></div></div></div>`);
        if (article.value.coverImage) {
          _push(`<div class="article-cover" data-v-c1d6307b><img${ssrRenderAttr("src", article.value.coverImage)}${ssrRenderAttr("alt", article.value.title)} data-v-c1d6307b></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="article-content" data-v-c1d6307b>${unref(sanitizeHtml)(article.value.content) ?? ""}</div>`);
        _push(ssrRenderComponent(_component_el_divider, null, null, _parent));
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "detail-loading" }, _attrs))} data-v-c1d6307b>`);
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c1d6307b"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-C69zjq6N.mjs.map
