...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_el_tag = ElTag;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "blog-layout" }, _attrs))} data-v-d5d7b704><div class="main-content" data-v-d5d7b704><div class="search-bar" data-v-d5d7b704>`);
      ...
      _push(`</div>`);
      if (loading.value) {
        _push(`<div class="skeleton-grid" data-v-d5d7b704><!--[-->`);
        ssrRenderList(4, (i) => {
          _push(ssrRenderComponent(_component_el_skeleton, {
            ...
            template: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div style="${ssrRenderStyle({ "padding": "0" })}" data-v-d5d7b704${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "image",
                  style: { "width": "100%", "height": "180px", "border-radius": "8px 8px 0 0" }
                }, null, _parent2, _scopeId));
                _push2(`<div style="${ssrRenderStyle({ "padding": "14px" })}" data-v-d5d7b704${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "text",
                  style: { "width": "40%" }
                }, null, _parent2, _scopeId));
        ...
        _push(`<div class="article-grid" data-v-d5d7b704><!--[-->`);
      ...
      if (total.value > pageSize.value) {
        _push(`<div class="pagination-wrapper" data-v-d5d7b704>`);
      ...
      _push(`</div><aside class="sidebar" data-v-d5d7b704><div class="widget" data-v-d5d7b704><h3 class="widget-title" data-v-d5d7b704>📂 分类</h3>`);
      if (categories.value.length) {
        _push(`<ul class="category-list" data-v-d5d7b704><!--[-->`);
        ssrRenderList(categories.value, (cat) => {
          _push(`<li class="${ssrRenderClass({ active: activeCategoryId.value === cat.id })}" data-v-d5d7b704>${ssrInterpolate(cat.name)}</li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<p class="empty-hint" data-v-d5d7b704>暂无分类</p>`);
      }
      _push(`</div><div class="widget" data-v-d5d7b704><h3 class="widget-title" data-v-d5d7b704>🏷️ 标签</h3>`);
      if (tags.value.length) {
        _push(`<div class="tag-cloud" data-v-d5d7b704><!--[-->`);
        ...
        _push(`<p class="empty-hint" data-v-d5d7b704>暂无标签</p>`);
      }
      _push(`</div></aside></div>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d5d7b704"]]);

export { index as default };
//# sourceMappingURL=index-g4-MO4uP.mjs.map
