import { w as withInstall, f as withNoopInstall, g as useGlobalConfig, u as useSizeProp, n as useLocale, R as addClass, S as removeClass, U as getProp, a as ElIcon, C as arrow_right_default, V as arrow_up_default, W as arrow_down_default, X as hasClass, P as getEventCode, Q as EVENT_CODE, l as loading_default } from './request-CPAxCwDy.mjs';
import { g as useNamespace, j as isNumber, l as isUndefined, f as debugWarn, i as isBoolean, y as isPropAbsent, s as isElement, t as throwError } from './server.mjs';
import { E as ElScrollbar, i as isGreaterThan } from './el-scrollbar-D9tL2LRa.mjs';
import normalizeWheel from 'normalize-wheel-es';
import { debounce, isNull, castArray, merge, flatMap, get } from 'lodash-unified';
import { u as useTooltipContentProps, E as ElTooltip } from './el-popper-Dwc4J52N.mjs';
import { ref, defineComponent, useSlots, getCurrentInstance, computed, openBlock, createBlock, provide, createElementBlock, unref, normalizeStyle, normalizeClass, createElementVNode, renderSlot, withDirectives, createVNode, createCommentVNode, withCtx, createTextVNode, toDisplayString, vShow, watchEffect, Fragment, h, isRef, nextTick, watch, inject, reactive, Comment, isVNode, toRefs, resolveComponent, renderList, render } from 'vue';
import { isArray, isString, hasOwn, isObject, isFunction } from '@vue/shared';
import { isClient } from '@vueuse/core';
import { E as ElCheckbox, a as ElCheckboxGroup } from './el-checkbox-Bx8h8Krp.mjs';
import { _ as _plugin_vue_export_helper_default } from './scroll-CAX4BlZD.mjs';
import { b as useFormSize, r as rAF } from './el-button-DZeW7ss9.mjs';
...
const useTableHeight = (offset = 0) => {
  const wrapperRef = ref();
  const tableHeight = ref(void 0);
  return { wrapperRef, tableHeight };
};

export { ElTable as E, ElTableColumn as a, useTableHeight as u };
//# sourceMappingURL=useTableHeight-jrpI8LMM.mjs.map
