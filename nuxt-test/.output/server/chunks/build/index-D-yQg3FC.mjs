import { c as ElInput, a2 as search_default, E as ElButton, d as ElMessage } from './request-CP76w0Lz.mjs';
import { E as ElSkeleton, a as ElSkeletonItem } from './el-skeleton-CVjXudrl.mjs';
import { E as ElEmpty } from './el-empty-QsvOjOHy.mjs';
...
import { E as ElPagination } from './el-pagination-BzYoIOKn.mjs';
import { u as useArticle } from './useArticle-Ci7nd5-Y.mjs';
import 'axios';
import '@vue/shared';
...
import 'unhead/utils';
import 'vue-router';
import './el-select-3aUyaKWm.mjs';
import './el-scrollbar-Cw4czMjJ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_el_tag = ElTag;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "blog-layout" }, _attrs))} data-v-71b51ae4><div class="main-content" data-v-71b51ae4><div class="search-bar" data-v-71b51ae4>`);
      ...
      _push(`</div>`);
      if (loading.value) {
        _push(`<div class="skeleton-grid" data-v-71b51ae4><!--[-->`);
        ssrRenderList(4, (i) => {
          _push(ssrRenderComponent(_component_el_skeleton, {
            ...
            template: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div style="${ssrRenderStyle({ "padding": "0" })}" data-v-71b51ae4${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "image",
                  style: { "width": "100%", "height": "180px", "border-radius": "8px 8px 0 0" }
                }, null, _parent2, _scopeId));
                _push2(`<div style="${ssrRenderStyle({ "padding": "14px" })}" data-v-71b51ae4${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "text",
                  style: { "width": "40%" }
                }, null, _parent2, _scopeId));
        ...
        _push(`<div class="article-grid" data-v-71b51ae4><!--[-->`);
      ...
      if (total.value > pageSize.value) {
        _push(`<div class="pagination-wrapper" data-v-71b51ae4>`);
      ...
      _push(`</div><aside class="sidebar" data-v-71b51ae4><div class="widget" data-v-71b51ae4><h3 class="widget-title" data-v-71b51ae4>📂 分类</h3>`);
      if (categories.value.length) {
        _push(`<ul class="category-list" data-v-71b51ae4><!--[-->`);
        ssrRenderList(categories.value, (cat) => {
          _push(`<li class="${ssrRenderClass({ active: activeCategoryId.value === cat.id })}" data-v-71b51ae4>${ssrInterpolate(cat.name)}</li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<p class="empty-hint" data-v-71b51ae4>暂无分类</p>`);
      }
      _push(`</div><div class="widget" data-v-71b51ae4><h3 class="widget-title" data-v-71b51ae4>🏷️ 标签</h3>`);
      if (tags.value.length) {
        _push(`<div class="tag-cloud" data-v-71b51ae4><!--[-->`);
        ...
        _push(`<p class="empty-hint" data-v-71b51ae4>暂无标签</p>`);
      }
      _push(`</div></aside></div>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-71b51ae4"]]);

export { index as default };
//# sourceMappingURL=index-D-yQg3FC.mjs.map
