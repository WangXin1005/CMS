import { E as ElButton, p as plus_default, f as ElIcon, w as withInstall, a as ElMessage, u as useFormItem, g as useFormSize, h as useFormItemInputId, i as useFormDisabled, j as addUnit, l as loading_default, k as buildProps, m as iconPropType, n as useAriaProps, o as definePropType } from './request-BRr5oPTU.mjs';
import { E as ElInput } from './el-input-o0G9miEB.mjs';
import { E as ElSelect, a as ElOption } from './el-select-Dhb4lrrd.mjs';
import { u as useTableHeight, E as ElTable, a as ElTableColumn } from './useTableHeight-BpYaU6Nu.mjs';
import { E as ElTag } from './index-CwwGAvkA.mjs';
...
import { E as ElMessageBox, i as isValidComponentSize } from './el-message-box-DyqsvXVs.mjs';
...
import { E as ElDialog } from './el-dialog-CG1pGxRa.mjs';
import { v as vLoading } from './el-loading-Cn8AZnH5.mjs';
...
import { u as useArticle } from './useArticle-h8e0rW9c.mjs';
import { u as useAuth } from './useAuth-Cg1tMEt9.mjs';
import 'axios';
...
import './el-scrollbar-4HhrLvPo.mjs';
import './scroll-DG0BuvGS.mjs';
import 'normalize-wheel-es';
import './el-checkbox-CN35zOcd.mjs';
...
import 'unhead/utils';
import 'vue-router';
import './el-overlay-wR9-YhVt.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "flex": "1", "min-height": "0", "display": "flex", "flex-direction": "column" } }, _attrs))} data-v-746fcbbb><div class="page-header" data-v-746fcbbb><h2 data-v-746fcbbb>文章管理</h2>`);
      if (!isGuest.value) {
      ...
      _push(`</div><div class="page-card" style="${ssrRenderStyle({ "flex": "1", "min-height": "0" })}" data-v-746fcbbb><div class="filter-bar" style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "12px", "flex-wrap": "wrap" })}" data-v-746fcbbb><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center" })}" data-v-746fcbbb>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_icon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-746fcbbb${_scopeId2}><path fill="currentColor" d="m795.904 750.72 124.992 124.928a32 32 0 0 1-45.248 45.248L750.656 795.904a416 416 0 1 1 45.248-45.248zM480 832a352 352 0 1 0 0-704 352 352 0 0 0 0 704" data-v-746fcbbb${_scopeId2}></path></svg>`);
                } else {
                  return [
      ...
      _push(`</div><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "12px", "margin-left": "auto" })}" data-v-746fcbbb>`);
      ...
      _push(ssrRenderComponent(_component_el_table, mergeProps({
        ...
        empty: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "padding": "40px 0", "color": "#909399" })}" data-v-746fcbbb${_scopeId}>暂无数据</div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row, $index }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "text-align": "center", "color": "#999", "font-size": "13px", "padding": "2px 0", "line-height": "1.2", "width": "100%" })}" data-v-746fcbbb${_scopeId2}>已加载全部</div>`);
                  } else {
                    _push3(`<span data-v-746fcbbb${_scopeId2}>${ssrInterpolate($index + 1)}</span>`);
                  }
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div class="cover-thumb-cell" data-v-746fcbbb${_scopeId2}>`);
                    if (row.coverImage) {
                      _push3(`<img${ssrRenderAttr("src", row.coverImage)} class="cover-thumb-img" data-v-746fcbbb${_scopeId2}>`);
                    } else {
                      _push3(`<div class="cover-thumb-placeholder" style="${ssrRenderStyle({ background: `linear-gradient(135deg, hsl(${row.id * 137 % 360}, 70%, 60%), hsl(${(row.id * 137 + 60) % 360}, 70%, 40%))` })}" data-v-746fcbbb${_scopeId2}><span class="cover-thumb-char" data-v-746fcbbb${_scopeId2}>${ssrInterpolate((row.title || "")[0])}</span></div>`);
                    }
                    _push3(`</div>`);
                  } else {
                    _push3(`<!---->`);
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "6px", "cursor": "pointer" })}"${ssrRenderAttr("type", isGuest.value ? "default" : "primary")}${ssrRenderAttr("underline", !isGuest.value)} data-v-746fcbbb${_scopeId2}><span style="${ssrRenderStyle({ "color": "#409eff", "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" })}" data-v-746fcbbb${_scopeId2}>${ssrInterpolate(row.title)}</span></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "flex-wrap": "wrap" })}" data-v-746fcbbb${_scopeId2}><!--[-->`);
            ...
            if (!isGuest.value) {
              _push2(ssrRenderComponent(_component_el_table_column, {
                ...
                default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (!row._isEndMarker) {
                      _push3(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px" })}" data-v-746fcbbb${_scopeId2}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (dialogArticle.value) {
              _push2(`<!--[--><div style="${ssrRenderStyle({ "margin-bottom": "16px", "padding-bottom": "12px", "border-bottom": "1px solid #ebeef5" })}" data-v-746fcbbb${_scopeId}><h3 style="${ssrRenderStyle({ "margin": "0 0 8px 0", "font-size": "20px" })}" data-v-746fcbbb${_scopeId}>${ssrInterpolate(dialogArticle.value.title)}</h3><div style="${ssrRenderStyle({ "display": "flex", "gap": "16px", "color": "#909399", "font-size": "13px" })}" data-v-746fcbbb${_scopeId}><span data-v-746fcbbb${_scopeId}>作者: ${ssrInterpolate(dialogArticle.value.author?.username)}</span><span data-v-746fcbbb${_scopeId}>分类: ${ssrInterpolate(dialogArticle.value.category?.name || "-")}</span><span data-v-746fcbbb${_scopeId}>${ssrInterpolate((dialogArticle.value.createdAt || "").replace("T", " ").slice(0, 16))}</span><span data-v-746fcbbb${_scopeId}>阅读: ${ssrInterpolate(dialogArticle.value.viewCount || 0)}</span></div></div><div class="article-preview-content" style="${ssrRenderStyle({ "max-height": "60vh", "overflow": "auto", "line-height": "1.8" })}" data-v-746fcbbb${_scopeId}>${unref(sanitizeHtml)(dialogArticle.value.content || "") ?? ""}</div><!--]-->`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-746fcbbb"]]);

export { index as default };
//# sourceMappingURL=index-CLrOY5xb.mjs.map
