...
import './el-loading-BNNL0NFf.mjs';
import '@tiptap/vue-3';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="page-card" data-v-77d8ce76>`);
...
const create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-77d8ce76"]]);

export { create as default };
//# sourceMappingURL=create-Cte4NOl2.mjs.map
