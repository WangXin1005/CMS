import { E as ElButton, p as plus_default, f as ElIcon, r as rank_default, w as withInstall, a as ElMessage, u as useFormItem, g as useFormSize, h as useFormItemInputId, i as useFormDisabled, j as addUnit, l as loading_default, k as buildProps, m as iconPropType, n as useAriaProps, o as definePropType } from './request-DjYQ2LWV.mjs';
import { E as ElInput } from './el-input-CF5MZqZY.mjs';
import { E as ElSelect, a as ElOption } from './el-select-BZB3TeJD.mjs';
import { u as useTableHeight, E as ElTable, a as ElTableColumn } from './useTableHeight-DSL-YHqG.mjs';
import { E as ElTag } from './index-Dk8Y1Ngv.mjs';
import { U as UPDATE_MODEL_EVENT, C as CHANGE_EVENT, I as INPUT_EVENT } from './raf-BAuwCRq7.mjs';
import { _ as _export_sfc, n as navigateTo, h as useNamespace, m as isBoolean, i as isNumber, v as throwError, g as debugWarn } from './server.mjs';
import { NOOP, isString, isPromise } from '@vue/shared';
import { E as ElMessageBox, i as isValidComponentSize } from './el-message-box-BRgLdd9_.mjs';
import { defineComponent, computed, ref, watch, nextTick, mergeProps, unref, withCtx, createTextVNode, openBlock, createBlock, createVNode, Fragment, renderList, toDisplayString, createCommentVNode, shallowRef, createElementBlock, withModifiers, normalizeClass, createElementVNode, withKeys, renderSlot, resolveDynamicComponent, normalizeStyle, useSSRContext } from 'vue';
...
import './el-checkbox-CAsBnB31.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function tableRowClassName({ row }) {
      if (row._isEndMarker) return "end-marker-row";
      return "";
    }
    ...
    function tryInitSortable(retryCount = 10) {
      const el = (void 0).querySelector(".el-table__body-wrapper tbody");
      ...
      sortableInstance = Sortable.create(el, {
        ...
        onEnd: async (evt) => {
          ...
          articles.value = list;
          const orders = list.map((item, idx) => ({ id: item.id, sortOrder: 1e7 - idx }));
          try {
    ...
    watch(tableKey, () => {
      if (isAdmin.value) nextTick(() => initSortable());
    });
    async function loadData(append = false) {
      ...
      try {
        ...
        nextTick(() => {
          ...
          if (append && isAdmin.value) initSortable();
        });
      }
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "flex": "1", "min-height": "0", "display": "flex", "flex-direction": "column" } }, _attrs))} data-v-97e9eec9><div class="page-header" data-v-97e9eec9><h2 data-v-97e9eec9>文章管理</h2>`);
      if (!isGuest.value) {
      ...
      _push(`</div><div class="page-card" style="${ssrRenderStyle({ "flex": "1", "min-height": "0" })}" data-v-97e9eec9><div class="filter-bar" style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "12px", "flex-wrap": "wrap" })}" data-v-97e9eec9><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center" })}" data-v-97e9eec9>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_icon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-97e9eec9${_scopeId2}><path fill="currentColor" d="m795.904 750.72 124.992 124.928a32 32 0 0 1-45.248 45.248L750.656 795.904a416 416 0 1 1 45.248-45.248zM480 832a352 352 0 1 0 0-704 352 352 0 0 0 0 704" data-v-97e9eec9${_scopeId2}></path></svg>`);
                } else {
                  return [
      ...
      _push(`</div><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "12px", "margin-left": "auto" })}" data-v-97e9eec9>`);
      ...
      _push(ssrRenderComponent(_component_el_table, mergeProps({
        ...
        empty: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "padding": "40px 0", "color": "#909399" })}" data-v-97e9eec9${_scopeId}>暂无数据</div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row, $index }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "text-align": "center", "color": "#999", "font-size": "13px", "padding": "2px 0", "line-height": "1.2", "width": "100%" })}" data-v-97e9eec9${_scopeId2}>已加载全部</div>`);
                  } else {
                    _push3(`<span data-v-97e9eec9${_scopeId2}>${ssrInterpolate($index + 1)}</span>`);
                  }
                } else {
                  return [
              ...
              default: withCtx(({ row, $index }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row._isEndMarker) {
                    ...
                    _push3(`<span style="${ssrRenderStyle({ "color": "#999", "font-size": "13px" })}" data-v-97e9eec9${_scopeId2}>${ssrInterpolate($index + 1)}</span>`);
                  }
                } else {
                  return [
                    row._isEndMarker ? (openBlock(), createBlock("div", {
                      key: 0,
                      style: { "text-align": "center", "color": "#999", "font-size": "13px", "padding": "2px 0", "line-height": "1.2", "width": "100%" }
                    }, "已加载全部")) : isAdmin.value ? (openBlock(), createBlock(_component_el_icon, {
                      key: 1,
                      class: "drag-handle",
                      style: { "cursor": "grab", "color": "#bbb", "font-size": "16px" }
                    }, {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div class="cover-thumb-cell" data-v-97e9eec9${_scopeId2}>`);
                    if (row.coverImage) {
                      _push3(`<img${ssrRenderAttr("src", row.coverImage)} class="cover-thumb-img" data-v-97e9eec9${_scopeId2}>`);
                    } else {
                      _push3(`<div class="cover-thumb-placeholder" style="${ssrRenderStyle({ background: `linear-gradient(135deg, hsl(${row.id * 137 % 360}, 70%, 60%), hsl(${(row.id * 137 + 60) % 360}, 70%, 40%))` })}" data-v-97e9eec9${_scopeId2}><span class="cover-thumb-char" data-v-97e9eec9${_scopeId2}>${ssrInterpolate((row.title || "")[0])}</span></div>`);
                    }
                    _push3(`</div>`);
                  } else {
                    _push3(`<!---->`);
                  ...
                  return [
                    !row._isEndMarker ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "cover-thumb-cell"
                    }, [
                      row.coverImage ? (openBlock(), createBlock("img", {
                        key: 0,
                        src: row.coverImage,
                        class: "cover-thumb-img"
                      }, null, 8, ["src"])) : (openBlock(), createBlock("div", {
                        key: 1,
                        class: "cover-thumb-placeholder",
                        style: { background: `linear-gradient(135deg, hsl(${row.id * 137 % 360}, 70%, 60%), hsl(${(row.id * 137 + 60) % 360}, 70%, 40%))` }
                      }, [
                        createVNode("span", { class: "cover-thumb-char" }, toDisplayString((row.title || "")[0]), 1)
                      ], 4))
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "6px", "cursor": "pointer" })}"${ssrRenderAttr("type", isGuest.value ? "default" : "primary")}${ssrRenderAttr("underline", !isGuest.value)} data-v-97e9eec9${_scopeId2}><span style="${ssrRenderStyle({ "color": "#409eff", "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" })}" data-v-97e9eec9${_scopeId2}>${ssrInterpolate(row.title)}</span></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "flex-wrap": "wrap" })}" data-v-97e9eec9${_scopeId2}><!--[-->`);
            ...
            if (!isGuest.value) {
              _push2(ssrRenderComponent(_component_el_table_column, {
                ...
                default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (!row._isEndMarker) {
                      _push3(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px" })}" data-v-97e9eec9${_scopeId2}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (dialogArticle.value) {
              _push2(`<!--[--><div style="${ssrRenderStyle({ "margin-bottom": "16px", "padding-bottom": "12px", "border-bottom": "1px solid #ebeef5" })}" data-v-97e9eec9${_scopeId}><h3 style="${ssrRenderStyle({ "margin": "0 0 8px 0", "font-size": "20px" })}" data-v-97e9eec9${_scopeId}>${ssrInterpolate(dialogArticle.value.title)}</h3><div style="${ssrRenderStyle({ "display": "flex", "gap": "16px", "color": "#909399", "font-size": "13px" })}" data-v-97e9eec9${_scopeId}><span data-v-97e9eec9${_scopeId}>作者: ${ssrInterpolate(dialogArticle.value.author?.username)}</span><span data-v-97e9eec9${_scopeId}>分类: ${ssrInterpolate(dialogArticle.value.category?.name || "-")}</span><span data-v-97e9eec9${_scopeId}>${ssrInterpolate((dialogArticle.value.createdAt || "").replace("T", " ").slice(0, 16))}</span><span data-v-97e9eec9${_scopeId}>阅读: ${ssrInterpolate(dialogArticle.value.viewCount || 0)}</span></div></div><div class="article-preview-content" style="${ssrRenderStyle({ "max-height": "60vh", "overflow": "auto", "line-height": "1.8" })}" data-v-97e9eec9${_scopeId}>${unref(sanitizeHtml)(dialogArticle.value.content || "") ?? ""}</div><!--]-->`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-97e9eec9"]]);

export { index as default };
//# sourceMappingURL=index-GQ8HyP9T.mjs.map
