import { f as ElIcon, l as loading_default, v as user_default, x as message_default$1, y as lock_default, E as ElButton, a as ElMessage } from './request-BRr5oPTU.mjs';
import { E as ElForm, a as ElFormItem } from './el-form-item-DAPAhOf6.mjs';
import { E as ElInput } from './el-input-o0G9miEB.mjs';
import { E as ElCheckbox } from './el-checkbox-CN35zOcd.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { login, registerGuest, initSuperAdmin, checkUsername } = useAuth();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "login-wrapper" }, _attrs))} data-v-8e9e1d7e>`);
      if (mode.value === "checking") {
        _push(`<div class="login-card" data-v-8e9e1d7e><div class="card-brand" data-v-8e9e1d7e><span class="brand-icon" data-v-8e9e1d7e>📝</span><h1 class="brand-title" data-v-8e9e1d7e>CodeBlog</h1></div><div class="checking-area" data-v-8e9e1d7e>`);
        ...
        _push(`<p data-v-8e9e1d7e>正在检查系统状态...</p></div></div>`);
      } else if (mode.value === "init") {
        _push(`<div class="login-card" data-v-8e9e1d7e><div class="card-brand" data-v-8e9e1d7e><span class="brand-icon" data-v-8e9e1d7e>🚀</span><h1 class="brand-title" data-v-8e9e1d7e>初始化系统</h1><p class="brand-desc" data-v-8e9e1d7e>首次使用，请创建超级管理员账号</p></div>`);
        ...
        _push(`<div class="login-card" data-v-8e9e1d7e><div class="card-brand" data-v-8e9e1d7e><span class="brand-icon" data-v-8e9e1d7e>📝</span><h1 class="brand-title" data-v-8e9e1d7e>CodeBlog</h1><p class="brand-desc" data-v-8e9e1d7e>欢迎回来，请登录您的账号</p></div>`);
        if (!showRegister.value) {
          _push(`<div data-v-8e9e1d7e>`);
          _push(ssrRenderComponent(_component_el_form, {
            "label-position": "top",
          ...
          _push(`<div class="form-footer" data-v-8e9e1d7e>`);
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e9e1d7e"]]);

export { Login as default };
//# sourceMappingURL=Login-Bex64VM7.mjs.map
