import { c as buildProps, d as definePropType, Q as EVENT_CODE, w as withInstall, ae as composeEventHandlers, P as getEventCode, ag as focusElement, aj as buildProp, ak as isShadowRoot, Y as getStyle } from './request-DEYIyDgU.mjs';
import { f as debugWarn, g as useNamespace, h as useId, i as isBoolean, v as useGetDerivedNamespace, w as useIdInjection, j as isNumber, o as useZIndex } from './server.mjs';
import { defineComponent, inject, withDirectives, cloneVNode, Comment, Fragment, Text, ref, toRef, computed, provide, unref, readonly, watch, openBlock, createBlock, withCtx, createVNode, renderSlot, createCommentVNode, createElementBlock, toDisplayString, normalizeClass, Teleport, Transition, mergeProps, vShow, normalizeStyle, nextTick, getCurrentInstance, shallowRef } from 'vue';
import { isClient, computedEager, onClickOutside, tryOnScopeDispose, useResizeObserver, unrefElement } from '@vueuse/core';
import { NOOP, isObject, isArray, isFunction } from '@vue/shared';
import { e as useAriaProps, h as formItemContextKey } from './el-button-BT_d7SyZ.mjs';
import { placements, createPopper } from '@popperjs/core';
import { isUndefined, fromPairs, isNil } from 'lodash-unified';
...
export { ElTooltip as E, FOCUS_TRAP_INJECTION_KEY as F, OnlyChild as O, _plugin_vue_export_helper_default as _, useTooltipTriggerProps as a, getScrollBarWidth as b, focus_trap_default$1 as f, getScrollContainer as g, roleTypes as r, scrollIntoView as s, useTooltipContentProps as u };
//# sourceMappingURL=el-popper-BwEgDlhM.mjs.map
