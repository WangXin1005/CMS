import { b as ElTooltip, c as ElButtonGroup, E as ElButton } from './request-CP-lljC1.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "rich-editor" }, _attrs))} data-v-1a6ec6ec>`);
      if (mode.value === "rich" && unref(editor)) {
        _push(`<div class="editor-toolbar" data-v-1a6ec6ec>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_button, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<strong data-v-1a6ec6ec${_scopeId3}>B</strong>`);
                        } else {
                          return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_button, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<em data-v-1a6ec6ec${_scopeId3}>I</em>`);
                        } else {
                          return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_button, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span style="${ssrRenderStyle({ "text-decoration": "line-through" })}" data-v-1a6ec6ec${_scopeId3}>S</span>`);
                        } else {
                          return [
      ...
      if (mode.value === "markdown") {
        _push(`<div class="markdown-editor-wrapper" data-v-1a6ec6ec><textarea class="markdown-textarea" placeholder="使用 Markdown 语法编写内容..." spellcheck="false" data-v-1a6ec6ec>${ssrInterpolate(markdownContent.value)}</textarea><div class="markdown-preview" data-v-1a6ec6ec><div class="preview-label" data-v-1a6ec6ec>预览</div><div class="preview-content" data-v-1a6ec6ec>${unref(sanitizeHtml)(previewHtml.value) ?? ""}</div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_8 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-1a6ec6ec"]]), { __name: "RichTextEditor" });

export { __nuxt_component_8 as _ };
//# sourceMappingURL=RichTextEditor-Xxz7u4zs.mjs.map
