import { a as ElIcon, W as arrow_down_default, a6 as home_filled_default, o as document_default, a7 as folder_default, a8 as price_tag_default, a9 as chat_dot_round_default, aa as picture_default, h as user_default, ab as setting_default, ac as list_default, ad as view_default, f as withNoopInstall, w as withInstall, E as ElMessage, c as buildProps, i as iconPropType, L as componentSizes, d as definePropType, Q as EVENT_CODE, ae as composeEventHandlers, n as useLocale, b as addUnit, C as arrow_right_default, af as more_default, m as mutable, ag as focusElement, P as getEventCode, ah as whenMouse, R as addClass, X as hasClass, S as removeClass } from './request.mjs';
import { _ as _export_sfc, d as useRoute, j as isNumber, h as useId, g as useNamespace, t as throwError, l as isUndefined } from './server.mjs';
import { mergeProps, defineComponent, computed, ref, withCtx, unref, createTextVNode, toDisplayString, createVNode, withModifiers, openBlock, createBlock, createCommentVNode, inject, provide, toRef, readonly, watch, getCurrentInstance, reactive, h, Fragment, withDirectives, vShow, watchEffect, useSSRContext, isVNode, cloneVNode, createElementBlock, normalizeStyle, normalizeClass, resolveDynamicComponent, renderSlot, Transition, toHandlers, useSlots, nextTick, createElementVNode, resolveComponent, normalizeProps, guardReactiveProps, createSlots } from 'vue';
import { u as useTooltipContentProps, r as roleTypes, a as useTooltipTriggerProps, O as OnlyChild, E as ElTooltip, _ as _plugin_vue_export_helper_default } from './el-popper.mjs';
import { castArray, isNil } from 'lodash-unified';
import { E as ElButton, b as useFormSize } from './el-button.mjs';
import { E as ElScrollbar } from './el-scrollbar.mjs';
import { useEventListener, useResizeObserver, useTimeoutFn, unrefElement } from '@vueuse/core';
import { E as ElDialog, c as composeRefs } from './el-dialog.mjs';
import { isString, isObject, isArray } from '@vue/shared';
import { f as flattedChildren, C as ClickOutside } from './index3.mjs';
import { placements } from '@popperjs/core';
import { E as ElForm, a as ElFormItem } from './el-form-item.mjs';
import { E as ElInput } from './el-input.mjs';
import { E as ElTag } from './index4.mjs';
import { E as ElDivider } from './el-divider.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_header, { class: "admin-header" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header-left" data-v-3a922d8a${_scopeId}><span class="header-title" data-v-3a922d8a${_scopeId}>${ssrInterpolate(unref(currentTitle))}</span></div><div class="header-right" data-v-3a922d8a${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_dropdown, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="user-info" data-v-3a922d8a${_scopeId2}>`);
                  ...
                  _push3(`<span class="username" data-v-3a922d8a${_scopeId2}>${ssrInterpolate(unref(username))}</span>`);
            ...
            return [
              createVNode("div", { class: "header-left" }, [
                createVNode("span", { class: "header-title" }, toDisplayString(unref(currentTitle)), 1)
              ]),
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-3a922d8a"]]), { __name: "Header" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_el_icon = ElIcon;
      const _component_el_divider = ElDivider;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "menu-container" }, _attrs))} data-v-548a6eae><div class="menu-logo" data-v-548a6eae><span class="logo-icon" data-v-548a6eae>📝</span><span class="logo-text" data-v-548a6eae>CodeBlog</span></div>`);
      _push(ssrRenderComponent(_component_el_menu, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/home" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-548a6eae${_scopeId2}>仪表盘</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
            ...
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/articles" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-548a6eae${_scopeId2}>文章管理</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
            ...
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/categories" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-548a6eae${_scopeId2}>分类管理</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
            ...
            _push2(ssrRenderComponent(_component_el_menu_item, { index: "/tags" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-548a6eae${_scopeId2}>标签管理</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/comments" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-548a6eae${_scopeId2}>评论管理</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/media" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-548a6eae${_scopeId2}>媒体管理</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/user" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-548a6eae${_scopeId2}>用户管理</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/setting" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-548a6eae${_scopeId2}>站点设置</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
              ...
              _push2(ssrRenderComponent(_component_el_menu_item, { index: "/logs" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-548a6eae${_scopeId2}>操作日志</span>`);
                  } else {
                    return [
                      createVNode(_component_el_icon, null, {
                        default: withCtx(() => [
            ...
            _push2(`<div class="menu-footer" data-v-548a6eae${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "8px 16px", "border-color": "#2a2a3d" } }, null, _parent2, _scopeId));
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_icon, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(view_default), null, null, _parent4, _scopeId3));
                      } else {
                        return [
                  ...
                  _push3(`<span data-v-548a6eae${_scopeId2}>返回博客</span>`);
                } else {
                  return [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
            ...
            return [
              ...
              createVNode("div", { class: "menu-footer" }, [
                createVNode(_component_el_divider, { style: { "margin": "8px 16px", "border-color": "#2a2a3d" } }),
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-548a6eae"]]), { __name: "Menu" });
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Header = __nuxt_component_0;
  const _component_Menu = __nuxt_component_1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-layout" }, _attrs))} data-v-562fa713>`);
  _push(ssrRenderComponent(_component_Header, null, null, _parent));
  _push(`<div class="admin-body" data-v-562fa713>`);
  _push(ssrRenderComponent(_component_Menu, null, null, _parent));
  _push(`<main class="admin-content" data-v-562fa713><div class="content-inner" data-v-562fa713>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-562fa713"]]);
