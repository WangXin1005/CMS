import { E as ElButton, a as ElMessage } from './request-BRr5oPTU.mjs';
...
import { _ as __nuxt_component_8 } from './RichTextEditor-D3jrcOoD.mjs';
...
import { defineComponent, computed, ref, mergeProps, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, withKeys, withModifiers, withDirectives, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div${ssrRenderAttrs(mergeProps({ style: { "overflow-y": "auto", "height": "100%" } }, ssrGetDirectiveProps(_ctx, _directive_loading, loading.value)))} data-v-82870d2a><div class="page-header" data-v-82870d2a><h2 data-v-82870d2a>编辑文章</h2><div data-v-82870d2a>`);
      ...
      _push(`</div></div>`);
      if (!loading.value) {
        _push(`<div class="page-card" data-v-82870d2a>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_el_form_item, { label: "封面图" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "8px", "flex-wrap": "wrap" })}" data-v-82870d2a${_scopeId2}>`);
                    ...
                    _push3(`</div>`);
                    if (form.value.coverImage) {
                      _push3(`<img${ssrRenderAttr("src", form.value.coverImage)} style="${ssrRenderStyle({ "margin-top": "8px", "max-width": "300px", "max-height": "200px", "border-radius": "6px", "border": "1px solid #e8e8e8", "display": "block" })}" data-v-82870d2a${_scopeId2}>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  } else {
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${ssrRenderAttrs(mergeProps({ style: { "min-height": "200px" } }, ssrGetDirectiveProps(_ctx, _directive_loading, mediaLoading.value)))} data-v-82870d2a${_scopeId}>`);
            if (mediaList.value.length === 0 && !mediaLoading.value) {
              _push2(`<div style="${ssrRenderStyle({ "text-align": "center", "padding": "60px 0", "color": "#999" })}" data-v-82870d2a${_scopeId}>暂无图片，请先在媒体管理中上传</div>`);
            } else {
              _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-wrap": "wrap", "gap": "12px" })}" data-v-82870d2a${_scopeId}><!--[-->`);
              ssrRenderList(mediaList.value, (m) => {
                _push2(`<div class="cover-picker-item" data-v-82870d2a${_scopeId}><img${ssrRenderAttr("src", m.url)}${ssrRenderAttr("alt", m.originalName)} data-v-82870d2a${_scopeId}><div class="cover-picker-name" data-v-82870d2a${_scopeId}>${ssrInterpolate(m.originalName)}</div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-82870d2a"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DiG2Iyy5.mjs.map
