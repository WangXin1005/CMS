...
import { s as isElement, f as debugWarn, h as useId, l as isUndefined } from './server.mjs';
import { isString, hasOwn, isObject, isFunction } from '@vue/shared';
import { _ as _plugin_vue_export_helper_default, f as focus_trap_default$1 } from './el-popper-BwEgDlhM.mjs';
import { L as componentSizes, T as TypeComponents, a as ElIcon, M as useGlobalComponentSettings, l as loading_default, N as TypeComponentsMap, O as obtainAllFocusableElements, P as getEventCode, Q as EVENT_CODE } from './request-DEYIyDgU.mjs';
import { E as ElOverlay, a as useDraggable, u as useLockscreen, b as useSameTarget } from './el-overlay-xyoVwH6f.mjs';
import { E as ElInput } from './el-input-C-yVO0IL.mjs';
import { E as ElButton } from './el-button-BT_d7SyZ.mjs';
import { isVNode, render, markRaw, createVNode, resolveComponent, openBlock, createBlock, Transition, withCtx, withDirectives, createElementVNode, normalizeClass, withModifiers, normalizeStyle, createElementBlock, resolveDynamicComponent, createCommentVNode, toDisplayString, withKeys, renderSlot, vShow, createTextVNode, defineComponent, computed, ref, reactive, watch, nextTick, toRefs } from 'vue';
...
const FOCUS_HANDLER = (e) => {
  ...
  if (focusableElement.length > 0 && code === EVENT_CODE.tab) {
    if (focusableElement.length === 1) {
      e.preventDefault();
      if ((void 0).activeElement !== focusableElement[0]) focusableElement[0].focus();
      return;
    }
...
const TrapFocus = {
  beforeMount(el) {
    ...
    FOCUS_STACK.push(el);
    if (FOCUS_STACK.length <= 1) (void 0).addEventListener("keydown", FOCUS_HANDLER);
  },
  updated(el) {
    nextTick(() => {
      el[FOCUSABLE_CHILDREN] = obtainAllFocusableElements(el);
  ...
  unmounted() {
    FOCUS_STACK.shift();
    if (FOCUS_STACK.length === 0) (void 0).removeEventListener("keydown", FOCUS_HANDLER);
  }
};
...
const getAppendToElement = (props) => {
  ...
  if (props.appendTo) {
    if (isString(props.appendTo)) appendTo = (void 0).querySelector(props.appendTo);
...
//# sourceMappingURL=el-message-box-2xKN0eaW.mjs.map
