...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "blog-layout" }, _attrs))} data-v-05bbb959><div class="sticky-top" data-v-05bbb959><div class="search-bar" data-v-05bbb959>`);
      ...
      _push(`</div><div class="filter-bar" data-v-05bbb959><div class="filter-section" data-v-05bbb959><span class="filter-label" data-v-05bbb959>📂 分类</span><div class="${ssrRenderClass([{ collapsed: !categoryExpanded.value }, "filter-items"])}" data-v-05bbb959><!--[-->`);
      ssrRenderList(categories.value, (cat) => {
        _push(`<span class="${ssrRenderClass([{ active: unref(activeCategoryId) === cat.id }, "filter-chip"])}" data-v-05bbb959>${ssrInterpolate(cat.name)}</span>`);
      });
      _push(`<!--]-->`);
      if (categories.value.length === 0) {
        _push(`<span class="filter-empty" data-v-05bbb959>暂无分类</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (categoryOverflow.value) {
        _push(`<div class="expand-row" data-v-05bbb959>${ssrInterpolate(categoryExpanded.value ? "▲ 收起" : "▼ 展开")}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="filter-section" data-v-05bbb959><span class="filter-label" data-v-05bbb959>🏷️ 标签</span><div class="${ssrRenderClass([{ collapsed: !tagExpanded.value }, "filter-items"])}" data-v-05bbb959><!--[-->`);
      ssrRenderList(tags.value, (tag) => {
        _push(`<span class="${ssrRenderClass([{ active: unref(activeTagId) === tag.id }, "filter-chip tag-chip"])}" data-v-05bbb959>${ssrInterpolate(tag.name)}</span>`);
      });
      _push(`<!--]-->`);
      if (tags.value.length === 0) {
        _push(`<span class="filter-empty" data-v-05bbb959>暂无标签</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (tagOverflow.value) {
        _push(`<div class="expand-row" data-v-05bbb959>${ssrInterpolate(tagExpanded.value ? "▲ 收起" : "▼ 展开")}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div><div class="blog-content-row" data-v-05bbb959><div class="main-content" data-v-05bbb959>`);
      if (loading.value) {
        _push(`<div class="skeleton-grid" data-v-05bbb959><!--[-->`);
        ssrRenderList(4, (i) => {
          _push(ssrRenderComponent(_component_el_skeleton, {
            ...
            template: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div style="${ssrRenderStyle({ "padding": "0" })}" data-v-05bbb959${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "image",
                  style: { "width": "100%", "height": "180px", "border-radius": "8px 8px 0 0" }
                }, null, _parent2, _scopeId));
                _push2(`<div style="${ssrRenderStyle({ "padding": "14px" })}" data-v-05bbb959${_scopeId}>`);
                _push2(ssrRenderComponent(_component_el_skeleton_item, {
                  variant: "text",
                  style: { "width": "40%" }
                }, null, _parent2, _scopeId));
        ...
        _push(`<div class="article-grid" data-v-05bbb959><!--[-->`);
      ...
      if (total.value > pageSize.value) {
        _push(`<div class="pagination-wrapper" data-v-05bbb959>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-05bbb959"]]);

export { index as default };
//# sourceMappingURL=index-DTaEb2Nx.mjs.map
