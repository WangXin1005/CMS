import { w as withInstall, D as useLocale, j as addUnit, k as buildProps } from './request-CP-lljC1.mjs';
import { h as useNamespace, q as useId } from './server.mjs';
...
var img_empty_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const id = useId();
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", _hoisted_1$1, [createElementVNode("defs", null, [
        createElementVNode("linearGradient", {
          ...
          offset: "100%"
        }, null, 8, _hoisted_4)], 8, _hoisted_2$1),
        createElementVNode("linearGradient", {
...
export { ElEmpty as E };
//# sourceMappingURL=el-empty-DB4zVA1P.mjs.map
