import { w as withInstall, m as buildProps, n as iconPropType, q as definePropType, x as useDeprecated, Q as focus_trap_default$1, y as useGlobalConfig, k as addUnit, G as useLocale, aD as FOCUS_TRAP_INJECTION_KEY, g as ElIcon, aE as CloseComponents } from './request-D1R8ryEy.mjs';
import { h as useNamespace, m as isBoolean, j as useZIndex, q as useId, g as debugWarn } from './server.mjs';
import { E as ElOverlay, u as useLockscreen, b as useSameTarget, a as useDraggable } from './el-overlay-BNEQhGxa.mjs';
import { U as UPDATE_MODEL_EVENT } from './el-button-BGrtg7cr.mjs';
import { defineComponent, useSlots, computed, ref, provide, openBlock, createBlock, Teleport, createVNode, Transition, mergeProps, unref, withCtx, withDirectives, createElementVNode, normalizeStyle, normalizeClass, createSlots, renderSlot, createCommentVNode, vShow, getCurrentInstance, watch, nextTick, inject, createElementBlock, toDisplayString, resolveDynamicComponent } from 'vue';
...
//# sourceMappingURL=el-dialog-PWL1fNax.mjs.map
