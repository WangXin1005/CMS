import { E as ElButton, p as plus_default, f as ElIcon, w as withInstall, a as ElMessage, u as useFormItem, g as useFormSize, h as useFormItemInputId, i as useFormDisabled, j as addUnit, l as loading_default, k as buildProps, m as iconPropType, n as useAriaProps, o as definePropType } from './request-CP-lljC1.mjs';
import { E as ElInput } from './el-input-Catjp5yv.mjs';
import { E as ElSelect, a as ElOption } from './el-select-Bi_DJ7oj.mjs';
import { u as useTableHeight, E as ElTable, a as ElTableColumn } from './useTableHeight-B9H4TheQ.mjs';
import { E as ElTag } from './index-CExFId52.mjs';
...
import { E as ElMessageBox, i as isValidComponentSize } from './el-message-box-DMKJ4Uzd.mjs';
...
import { E as ElDialog } from './el-dialog-DbZzzrvm.mjs';
import { v as vLoading } from './el-loading-CohBbOq9.mjs';
...
import { u as useArticle } from './useArticle-lGlkk3RZ.mjs';
import { u as useAuth } from './useAuth-LJZ-3bR0.mjs';
import 'axios';
...
import './el-scrollbar-B611xXi5.mjs';
import './scroll-Kff3_mQ7.mjs';
import 'normalize-wheel-es';
import './el-checkbox-B3Og54SW.mjs';
...
import 'unhead/utils';
import 'vue-router';
import './el-overlay-CS9RV7oQ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "flex": "1", "min-height": "0", "display": "flex", "flex-direction": "column" } }, _attrs))} data-v-bc760c24><div class="page-header" data-v-bc760c24><h2 data-v-bc760c24>文章管理</h2>`);
      if (!isGuest.value) {
      ...
      _push(`</div><div class="page-card" style="${ssrRenderStyle({ "flex": "1", "min-height": "0" })}" data-v-bc760c24><div class="filter-bar" style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "12px", "flex-wrap": "wrap" })}" data-v-bc760c24><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center" })}" data-v-bc760c24>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_icon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-bc760c24${_scopeId2}><path fill="currentColor" d="m795.904 750.72 124.992 124.928a32 32 0 0 1-45.248 45.248L750.656 795.904a416 416 0 1 1 45.248-45.248zM480 832a352 352 0 1 0 0-704 352 352 0 0 0 0 704" data-v-bc760c24${_scopeId2}></path></svg>`);
                } else {
                  return [
      ...
      _push(`</div><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "12px", "margin-left": "auto" })}" data-v-bc760c24>`);
      ...
      _push(ssrRenderComponent(_component_el_table, mergeProps({
        ...
        empty: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "padding": "40px 0", "color": "#909399" })}" data-v-bc760c24${_scopeId}>暂无数据</div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row, $index }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "text-align": "center", "color": "#999", "font-size": "13px", "padding": "2px 0", "line-height": "1.2", "width": "100%" })}" data-v-bc760c24${_scopeId2}>已加载全部</div>`);
                  } else {
                    _push3(`<span data-v-bc760c24${_scopeId2}>${ssrInterpolate($index + 1)}</span>`);
                  }
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "gap": "6px", "cursor": "pointer" })}"${ssrRenderAttr("type", isGuest.value ? "default" : "primary")}${ssrRenderAttr("underline", !isGuest.value)} data-v-bc760c24${_scopeId2}><span style="${ssrRenderStyle({ "color": "#409eff", "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" })}" data-v-bc760c24${_scopeId2}>${ssrInterpolate(row.title)}</span></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(_component_el_table_column, {
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (!row._isEndMarker) {
                    _push3(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "flex-wrap": "wrap" })}" data-v-bc760c24${_scopeId2}><!--[-->`);
            ...
            if (!isGuest.value) {
              _push2(ssrRenderComponent(_component_el_table_column, {
                ...
                default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (!row._isEndMarker) {
                      _push3(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px" })}" data-v-bc760c24${_scopeId2}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (dialogArticle.value) {
              _push2(`<!--[--><div style="${ssrRenderStyle({ "margin-bottom": "16px", "padding-bottom": "12px", "border-bottom": "1px solid #ebeef5" })}" data-v-bc760c24${_scopeId}><h3 style="${ssrRenderStyle({ "margin": "0 0 8px 0", "font-size": "20px" })}" data-v-bc760c24${_scopeId}>${ssrInterpolate(dialogArticle.value.title)}</h3><div style="${ssrRenderStyle({ "display": "flex", "gap": "16px", "color": "#909399", "font-size": "13px" })}" data-v-bc760c24${_scopeId}><span data-v-bc760c24${_scopeId}>作者: ${ssrInterpolate(dialogArticle.value.author?.username)}</span><span data-v-bc760c24${_scopeId}>分类: ${ssrInterpolate(dialogArticle.value.category?.name || "-")}</span><span data-v-bc760c24${_scopeId}>${ssrInterpolate((dialogArticle.value.createdAt || "").replace("T", " ").slice(0, 16))}</span><span data-v-bc760c24${_scopeId}>阅读: ${ssrInterpolate(dialogArticle.value.viewCount || 0)}</span></div></div><div class="article-preview-content" style="${ssrRenderStyle({ "max-height": "60vh", "overflow": "auto", "line-height": "1.8" })}" data-v-bc760c24${_scopeId}>${unref(sanitizeHtml)(dialogArticle.value.content || "") ?? ""}</div><!--]-->`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bc760c24"]]);

export { index as default };
//# sourceMappingURL=index-DbY-iq0j.mjs.map
