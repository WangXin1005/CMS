...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_id_-BV-IA1Ml.js")
  },
  {
    name: "articles-create",
    path: "/articles/create",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/create-76VmwYFU.js")
  },
  {
    name: "article-slug",
    path: "/article/:slug()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/_slug_-C23ctG9W.js")
  },
  {
    name: "articles",
    path: "/articles",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-DbY-iq0j.js")
  },
  {
    name: "categories",
    path: "/categories",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/categories-BXwXmihn.js")
  },
  {
    name: "Home",
    path: "/Home",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/Home-Tyq8l_SH.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-DuzNIl12.js")
  },
  {
    name: "logs",
    path: "/logs",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/logs-BHftiTdP.js")
  },
  {
    name: "media",
    path: "/media",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/media-g5sldlfZ.js")
  },
  {
    name: "setting",
    path: "/setting",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/setting-BZLlJKRx.js")
  },
  {
    name: "tags",
    path: "/tags",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/tags-BXmZn5uL.js")
  },
  {
    name: "user",
    path: "/user",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/user-DUvD38mh.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-5P8HwzA5.js")
  }
];
...
const layouts = {
  ...
  default: defineAsyncComponent(() => import("./_nuxt/default-B_cmOe_t.js").then((m) => m.default || m)),
  public: defineAsyncComponent(() => import("./_nuxt/public-ZDou4dxR.js").then((m) => m.default || m))
};
