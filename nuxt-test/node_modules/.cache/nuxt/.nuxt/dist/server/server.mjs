...
const _routes = [
  ...
  },
  {
    ...
    component: () => import("./_nuxt/_slug_-C69zjq6N.js")
  },
  {
    name: "articles",
    path: "/articles",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-Bh_GA00o.js")
  },
  {
    name: "categories",
    path: "/categories",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/categories-WRXIMm-1.js")
  },
  {
    name: "comments",
    path: "/comments",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/comments-BNud14ht.js")
  },
  {
    name: "Home",
    path: "/Home",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/Home-DJetav1N.js")
  },
  {
    name: "login",
    path: "/login",
  ...
  },
  {
    ...
    path: "/tags",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/tags-Bj2kZlAv.js")
  },
  {
    name: "user",
    path: "/user",
