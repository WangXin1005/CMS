...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_id_-DiG2Iyy5.js")
  },
  {
    name: "articles-create",
    path: "/articles/create",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/create-pblEGcIo.js")
  },
  {
    name: "article-slug",
    path: "/article/:slug()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/_slug_-Bz7zv0Fa.js")
  },
  {
    name: "articles",
    path: "/articles",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-CLrOY5xb.js")
  },
  {
    name: "categories",
    path: "/categories",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/categories-BOSOJgAV.js")
  },
  {
    name: "Home",
    path: "/Home",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/Home-Cr3BXcFS.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-Bek-i_fs.js")
  },
  {
    name: "logs",
    path: "/logs",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/logs-B5vNQTKX.js")
  },
  {
    name: "media",
    path: "/media",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/media-CNQz7SNG.js")
  },
  {
    name: "setting",
    path: "/setting",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/setting-CdvT6Mdw.js")
  },
  {
    name: "tags",
    path: "/tags",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/tags-Sa3bki7a.js")
  },
  {
    name: "user",
    path: "/user",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/user-CtLMgjbU.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-BAppT-cb.js")
  }
];
...
const layouts = {
  ...
  default: defineAsyncComponent(() => import("./_nuxt/default-qVTsScEX.js").then((m) => m.default || m)),
  public: defineAsyncComponent(() => import("./_nuxt/public-31loV56V.js").then((m) => m.default || m))
};
