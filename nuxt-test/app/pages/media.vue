<!-- media — 媒体管理页（ADMIN/SUPERADMIN）：文件上传、列表浏览、删除 -->
...
const mediaList = ref<Record<string, unknown>[]>([])
...
async function handleDelete(id: number) {
  try {
    await ElMessageBox.confirm('确定删除此文件？', '确认', {
...
<template>
  <div>
    ...
    <div class="page-card">
      <el-table v-loading="loading" :data="mediaList" stripe>
