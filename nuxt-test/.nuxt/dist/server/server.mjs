import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, computed, unref, defineAsyncComponent, defineComponent, h, provide, Suspense, nextTick, mergeProps, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "D:/projects/nuxtProject/nuxt-test/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/projects/nuxtProject/nuxt-test/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/projects/nuxtProject/nuxt-test/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/projects/nuxtProject/nuxt-test/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "D:/projects/nuxtProject/nuxt-test/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL } from "D:/projects/nuxtProject/nuxt-test/node_modules/ufo/dist/index.mjs";
...
const __nuxt_page_meta$2 = { layout: "public" };
const __nuxt_page_meta$1 = { layout: "blank" };
const __nuxt_page_meta = { layout: "public" };
const _routes = [
  {
    name: "articles-edit-id",
    path: "/articles/edit/:id()",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/_id_-iyE7QsiJ.js")
  },
  {
    name: "articles-create",
    path: "/articles/create",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/create-DDtvkG_M.js")
  },
  {
    name: "article-slug",
    path: "/article/:slug()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/_slug_-CWSa9c8-.js")
  },
  {
    name: "articles",
    path: "/articles",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-CB54O6y2.js")
  },
  {
    name: "categories",
    path: "/categories",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/categories-rR7cL6m3.js")
  },
  {
    name: "comments",
    path: "/comments",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/comments-DHnzvMu_.js")
  },
  {
    name: "Home",
    path: "/Home",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/Home-C3xCQWcG.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-BEsQpSak.js")
  },
  {
    name: "logs",
    path: "/logs",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/logs-excbq9vo.js")
  },
  {
    name: "media",
    path: "/media",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/media-CPkzdK64.js")
  },
  {
    name: "setting",
    path: "/setting",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/setting-B4v8yxAI.js")
  },
  {
    name: "tags",
    path: "/tags",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/tags-CKlw4SeY.js")
  },
  {
    name: "user",
    path: "/user",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/user-C2kTYg7V.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-Dnzwlvio.js")
  }
];
...
let _pending = null;
const init_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
  let __temp, __restore;
  ...
  if (!_pending) {
    _pending = $fetch("/api/users/check").then((res) => {
      _initialized = res?.exists === true;
    }).catch(() => {
      _pending = null;
    });
  }
  [__temp, __restore] = executeAsync(() => _pending), await __temp, __restore();
  if (_initialized === false && to.path !== "/login") {
    return navigateTo("/login");
  }
});
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-BkRyoTbx.js")
};
...
const layouts = {
  blank: defineAsyncComponent(() => import("./_nuxt/blank-D0MnAPB6.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-BU-bHSqb.js").then((m) => m.default || m)),
  public: defineAsyncComponent(() => import("./_nuxt/public-Be7snPVs.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DAc_0cLo.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CJ5aOB7_.js"));
